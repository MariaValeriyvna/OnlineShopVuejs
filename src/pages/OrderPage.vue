      ...
      <form class="cart__form form" action="#" method="POST" @submit.prevent='order'>
        <div class="cart__field">
          <div class="cart__data">
             ...
             title='ФИО' type='text' placeholder="Введите ваше полное имя" :error="formError.name"/>

            <BaseFormText v-model="formData.address"
             title='Адрес доставки' type='text'
             placeholder="Введите ваш адрес" :error="formError.address"/>

            <BaseFormText v-model="formData.phone"
             title='Телефон' type='tel' placeholder="Введите ваш телефон" :error="formError.phone"/>

            <BaseFormText v-model="formData.email"
             title='Email'  type="email" placeholder="Введите ваш Email" :error="formError.email"/>
        ...
        <div class="cart__block">
          ...
          <Preloader v-show="orderLoading"
          style= " width: 300px; height: 300px; top: 25%; right: 10%;"  />
        </div>
